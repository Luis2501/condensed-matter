...
for m, n in zip(np.arange(0, 1.25, 0.25), range(1,5)):
	...
	if m==0:
		...
		ax.plot(k_dist0,evals0[0], color=(0.76, 0.13, 0.28))
		ax.plot(k_dist0,evals0[1], color=(0.76, 0.13, 0.28))
		...
		ax.plot(k_dist,evals[0], color=(0.76, 0.13, 0.28))
		ax.plot(k_dist,evals[1], color=(0.76, 0.13, 0.28))
